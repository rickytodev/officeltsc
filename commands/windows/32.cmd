...
if not exist "C:\ProgramFiles(x86)%\Microsoft Office\Office16\ospp.vbs" (
    echo No se encuentra el archivo de comandos "C:\ProgramFiles(x86)%\Microsoft Office\Office16\ospp.vbs".
    exit /b 1
)

:: Cambiar al directorio donde está ospp.vbs
cd /d "C:\ProgramFiles(x86)%\Microsoft Office\Office16"
